						...
						<div class="col-sm-12">
							...
							<div id="main-menu" class="collapse scroll navbar-right">
								<ul class="nav">
                                    ...
                                    <li> <a href="#history">Problematica</a> </li>
                                    
                                    <li> <a href="#works">Objetivos</a> </li>
                                    
                                     <li> <a href="#team">Marco Teorico</a> </li>
...
viverra purus tristique.</p>
                   ...
                   <div class="blog-post">
                       ...
                       <div class="post-desc">
                           ...
                           <li>
                               ...
                               <ul>Actualizar el código para que se permita el procesamiento de imágenes y video para percibir las emociones de los estudiantes durante la clase en línea.</ul>
                               <ul>Alquilar un hosting y dominio profesional para el sistema web. </ul>
                               <ul>Para mejorar la usabilidad se debería realizar una retroalimentación de las críticas de los usuarios finales y llegar a una mejora significativa.</ul>
                               <ul>Para mejorar la mantenibilidad hay que definir exactamente los módulos que se necesitan dentro del sistema y estructurarlo de forma óptima para su posterior uso en proyecto más grandes.</ul>
                           </li>
                       </div>
                   </div>
               </div>
  ...
  <section id="testimonials">
                           ...
                           Actualizar el código para que se permita el procesamiento de imágenes y video para percibir las emociones de los estudiantes durante la clase en línea.
                           Alquilar un hosting y dominio profesional para el sistema web.
                           Para mejorar la usabilidad se debería realizar una retroalimentación de las críticas de los usuarios finales y llegar a una mejora significativa.
                           Para mejorar la mantenibilidad hay que definir exactamente los módulos que se necesitan dentro del sistema y estructurarlo de forma óptima para su posterior uso en proyecto más grandes.</b>
                        </p>                            
